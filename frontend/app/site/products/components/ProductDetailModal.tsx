    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 bg-white rounded-2xl shadow-xl max-w-3xl w-full animate-fadeIn max-h-[90vh] flex flex-col">
        ...
        <div className="p-6 md:p-8 pt-0 overflow-y-auto">
          <div className="mt-4">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">{product.prodName}</h2>
            <p className="text-2xl font-semibold text-green-600 mt-2">${Number(product.prodPrice).toFixed(2)}</p>
