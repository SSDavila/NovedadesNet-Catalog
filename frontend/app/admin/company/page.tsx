        ...
        <form className="bg-white p-8 rounded-lg shadow-md space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" id="companyName" defaultValue="Novedades.net S.A." className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm" />
            </div>
            <div>
              <label htmlFor="companyTradeName" className="block text-sm font-medium text-gray-700">Nombre Comercial</label>
              <input type="text" id="companyTradeName" defaultValue="Novedades.net" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm" />
            </div>
          </div>

          <div>
            <label htmlFor="companyRuc" className="block text-sm font-medium text-gray-700">RUC</label>
            <input type="text" id="companyRuc" defaultValue="1234567890001" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm" />
          </div>

          <div>
            <label htmlFor="companyAddress" className="block text-sm font-medium text-gray-700">Dirección Matriz</label>
            <input type="text" id="companyAddress" defaultValue="Av. Principal 123 y Calle Secundaria, Quito, Ecuador" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm" />
          </div>
          ...
          <div className="border-t pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div>
                ...
                <select id="sriEnvironment" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
