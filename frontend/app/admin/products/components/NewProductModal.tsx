...
export default function NewProductModal({ isOpen, onClose, onProductAdded }: NewProductModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fadeIn">
      <div className="bg-gray-100 rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col relative">
        ...
        <div className="flex-grow grid md:grid-cols-2 gap-6 p-6 overflow-hidden">
          ...
          <div className="hidden md:flex flex-col overflow-hidden">
            ...
            <div className="flex-grow overflow-y-auto rounded-2xl">
              <ProductPreview nombre={productData.prodName} precio={parseFloat(productData.prodPrice) || 0} descripcion={productData.prodDesc} imagenes={imagePreviews} />
            </div>
          </div>
        </div>
      </div>
